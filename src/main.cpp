...
const string strMessageMagic = "AndroidTokensX Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AndroidTokensX", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "ADTX is born";
        CTransaction txNew;
        txNew.nTime = 1500159211;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1500159211;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1067272;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
	...
	printf("Searching for genesis block...\n");
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd6c2e9b4ab2d0a722f566ad2f6cc54b3a861430572294188790926001ca51c1e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf2, 0xc0, 0xa8, 0xc7 };
