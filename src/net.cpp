...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("AndroidTokensX-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("AndroidTokensX-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("AndroidTokensX-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AndroidTokensX " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("AndroidTokensX-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("AndroidTokensX-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("AndroidTokensX-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("AndroidTokensX-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AndroidTokensX is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("AndroidTokensX-start");
